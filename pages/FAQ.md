...
Tags and their corresponding categories need to be separated with a vertical bar, like this: Tag | Tag 2, and so on. (If you’re encountering the “save” issue with your annotations, it may also be because the tag column in your Annotation spreadsheet isn’t properly formatted.) See example below. 
...
## Why can people see the backend of my project if I give them the link? 
GitHub repositories are typically public. AVAnnotate is an interface to interact with that public repository. As a result, other users can see the backend of your AVAnnotate project just like they can see your GitHub repository, but they can't edit or affect the project unless you have added them as collaborators. If you were to set your project to private, only collaborators should be able to see it.
